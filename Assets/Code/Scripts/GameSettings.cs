...
public class GameSettings : IInitializable
{
    ...
    {
        SetFrameRate(GetTargetFrameRate());
        SetLanguage(new CultureInfo(GetLanguage()));
        SetMusic(IsMusicEnabled());
        SetSfx(IsSfxEnabled());
        SetUISound(IsUISoundEnabled());
    }

    public static bool IsMusicEnabled() => 
        PlayerPrefs.GetInt(MusicKey, true.ToInt()).ToBoolean();

    public static void SetMusic(bool value) => 
        PlayerPrefs.SetInt(MusicKey, value.ToInt());

    public static bool IsSfxEnabled() => 
        PlayerPrefs.GetInt(SfxKey, true.ToInt()).ToBoolean();

    public static void SetSfx(bool value) => 
        PlayerPrefs.SetInt(SfxKey, value.ToInt());

    public static bool IsUISoundEnabled() => 
        PlayerPrefs.GetInt(UISoundKey, true.ToInt()).ToBoolean();

    public static void SetUISound(bool value) => 
        PlayerPrefs.SetInt(UISoundKey, value.ToInt());

    public static int GetTargetFrameRate() => 
        PlayerPrefs.GetInt(FrameRateKey, DefaultFrameRate);

    public static string GetLanguage() => 
        PlayerPrefs.GetString(LanguageKey, DefaultLanguage);

    public static void ResetLanguage() => 
        SetLanguage(new CultureInfo(DefaultLanguage));
